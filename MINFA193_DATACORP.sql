DROP database MINFA193_DATACORP;
CREATE DATABASE MINFA193_DATACORP;
use MINFA193_DATACORP;
--
-- Database: `MINFA193_DATACORP`
--
...
INSERT INTO `badge` (`Badgeid`, `RFIDkey`)
VALUES (2, 'AB123'),
  (3, 'AB123F'),
  (4, 'AB57FC'),
  (7, 'ABC14'),
...
VALUES (
    ...
    'A01',
    20,
    'The Room has a projector and 20 laptops with docking stations'
  ),
  (
    2,
    'A02',
    15,
    'The Room has a projector and 15 laptops with docking stations'
  ),
  (
    3,
    'A03',
...
VALUES (
    ...
    'minfa193@gmail.com',
    'Miniatis',
    '$2y$10$b91tDdJtkj.jxGS2FVJV6OQ69zclzN8SqwREEK7.RWZFblYcVxrJ2',
    1,
    1
  );
-- --------------------------------------------------------
...
INSERT INTO `groups_permitions` (
    `group_id`,
    `group_name`,
    `administrator`,
    `open_doors_when_free`,
    `can_reserv`,
    `view_sensitive_data`
  )
VALUES (1, 'Administrator', 1, 1, 1, 1),
...
INSERT INTO `time_of_reservation` (`id`, `start_time`, `end_time`)
VALUES (1, 8, 9),
  (2, 9, 10),
  (3, 10, 11),
  (4, 11, 12),
